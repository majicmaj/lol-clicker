      ...
      <div className="relative bg-[#091428]/90 p-8 border-2 border-[#C8AA6E] shadow-lg shadow-[#C8AA6E]/20 max-w-md w-full backdrop-blur-sm">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="relative mb-4 transform hover:scale-105 transition-transform duration-300">
            <div className={`absolute inset-0 blur-xl opacity-40 bg-gradient-to-b ${rankGradient}`} />
            <img 
              src={rankImage} 
              alt={player.rank} 
          ...
          <div className="text-center space-y-2">
            <div className={`text-4xl font-beaufort font-bold bg-gradient-to-r ${rankGradient} text-transparent bg-clip-text`}>
              {player.rank}
            </div>
            ...
            <div className="text-3xl font-bold text-white font-beaufort">
              ...
              {player.lastLpChange !== 0 && (
                <span className={`ml-2 ${player.lastLpChange > 0 ? 'text-green-500' : 'text-red-500'}`}>
                  {player.lastLpChange > 0 ? '+' : ''}{player.lastLpChange}
                </span>
              )}
            </div>
